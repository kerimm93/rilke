...
var APP_ROOT_PATH = new URL('./', self.location.href).pathname;
var CACHE_PREFIX = 'rilke-app-' + encodeURIComponent(APP_ROOT_PATH) + '-';
var CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
var APP_SHELL_PATH = new URL('./index.html', self.location.href).pathname;
...
function isAppShellNavigation(requestUrl) {
  return requestUrl.pathname === APP_ROOT_PATH || requestUrl.pathname === APP_SHELL_PATH;
}
