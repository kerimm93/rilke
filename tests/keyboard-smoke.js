...
const context = {
  ...
  $:id=>id === 'cards-tree' ? container : id === 'modal-overlay' ? overlay : id === 'modal-body' ? modalBody : id === 'm-text' ? textArea : id === 'm-comment' ? commentArea : id === 'm-status' ? statusSelect : id === 'm-title' ? titleInput : null,
